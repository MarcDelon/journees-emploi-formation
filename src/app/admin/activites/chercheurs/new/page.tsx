...
import { createJobSeekerActivity } from '../../../../../lib/supabase.queries'

export default function NewJobSeekerActivity() {
  ...
  const [formData, setFormData] = useState({
    ...
    skills: '',
    availability: '',
    experience_level: 'Débutant' as 'Débutant' | 'Intermédiaire' | 'Expérimenté',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/admin/activites/chercheurs')
    } catch (error) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <Link
                href="/admin/activites/chercheurs"
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Nouvelle Activité Chercheur d'Emploi</h1>
                <p className="text-sm text-gray-500">Créer une nouvelle activité</p>
              </div>
            </div>
            <button
              onClick={() => router.push('/admin/activites/chercheurs')}
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Nom du chercheur d'emploi"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-event-blue focus:border-transparent"
                placeholder="Disponibilité (ex: Immédiate, 1 mois, etc.)"
              />
            </div>
