              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-10">
                  {p.logoUrl ? (
                    ...
                    <img src={p.logoUrl} alt={p.nom} className="w-[70%] h-[70%] object-contain" />
                  ) : (
                    <Building className="w-56 h-56 text-gray-400" />
                  )}
                </div>
                ...
                <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
                  ...
                  <motion.h3
                    className="mt-4 text-3xl md:text-4xl font-bold text-gray-900 drop-shadow-sm"
                    initial={{ y: 10, opacity: 0 }}
                    animate={{ y: isActive ? 0 : 10, opacity: isActive ? 1 : 0 }}
                  ...
                  >
                    {p.description || 'Partenaire de l’événement – slogan à venir'}
                  </motion.p>
                  {p.siteWeb && (
                    <motion.a
                      href={p.siteWeb}
                      ...
                      className="mt-5 inline-flex items-center bg-white text-black border-2 border-black px-5 py-2 rounded-full hover:bg-gray-50 transition"
                      initial={{ y: 10, opacity: 0 }}
                      animate={{ y: isActive ? 0 : 10, opacity: isActive ? 1 : 0 }}
